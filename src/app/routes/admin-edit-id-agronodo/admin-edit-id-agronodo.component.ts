...
@Component({
  selector: "app-admin-edit-id-agronodo",
  templateUrl: "./admin-edit-id-agronodo.component.html",
  styleUrls: ["./admin-edit-id-agronodo.component.scss"]
})
export class AdminEditIDAgronodoComponent implements OnInit {
